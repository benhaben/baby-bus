...
namespace BabyBus.Logic.Shared
{
	public sealed class RSAFromPkcs8
	{
		...
		public static bool verify(string content, string signedString, string publicKey)
		{
			...
			System.Security.Cryptography.RSAParameters paraPub = ConvertFromPublicKey(publicKey);
		...
		/// <returns></returns>
		static RSACryptoServiceProvider DecodePemPrivateKey(String pemstr)
		{
		...
		static RSACryptoServiceProvider DecodeRSAPrivateKey(byte[] privkey)
		{
			...
			try {
				...
				RSAParameters RSAparams = new System.Security.Cryptography.RSAParameters();
		...
		private static System.Security.Cryptography.RSAParameters ConvertFromPublicKey(string pemFileConent)
		{
			...
			System.Security.Cryptography.RSAParameters para = new System.Security.Cryptography.RSAParameters();
