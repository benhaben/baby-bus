...
{
    public abstract class MvxBabyBusBaseViewController : MvxViewController
    {
        ...
        public MvxBabyBusBaseViewController()
            : base()
        {
            InitEvent();
        }

        public MvxBabyBusBaseViewController(IntPtr handle)
            : base(handle)
        {
            InitEvent();
        }
        ...
        public MvxBabyBusBaseViewController(string nibName, NSBundle bundle)
            : base(nibName, bundle)
        {
            InitEvent();
        }
