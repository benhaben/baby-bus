...
namespace AlipayApp.AlipayAPI
{
    public class Base64
    {
        private const int BASELENGTH = 128;
        ...
        static byte[] base64Alphabet = new byte[BASELENGTH];
        static char[] lookUpBase64Alphabet = new char[LOOKUPLENGTH];
        static Base64()
        {
        ...
        {
            return (octect < BASELENGTH && base64Alphabet[octect] != 0);
        }
