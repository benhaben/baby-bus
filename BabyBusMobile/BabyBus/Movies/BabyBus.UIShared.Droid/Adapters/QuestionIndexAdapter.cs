...
namespace BabyBus.Droid.Adapters
{
	public class QuestionIndexAdapter : BaseAdapter
	{
		...
		public override View GetView(int position, View convertView, ViewGroup parent)
		{
			...
			holder.AnswerContent.Visibility = item.HasAnswer ? ViewStates.Visible : ViewStates.Gone;
			...
			holder.UnAnswer.Visibility = item.HasAnswer ? ViewStates.Gone : ViewStates.Visible;
