...
{
    public class MvxXListView : MvxListView, AbsListView.IOnScrollListener
    {
        ...
        private IMvxAdapter _adapter;


        public MvxXListView(Context context, IAttributeSet attrs)
            : this(context, attrs, new MvxAdapter(context)) {

        }

        public MvxXListView(Context context, IAttributeSet attrs, IMvxAdapter adapter)
        ...
        public new IMvxAdapter Adapter {
            get { return _adapter as IMvxAdapter; }
            set {
