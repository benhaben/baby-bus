...
namespace SDWebImage {
    ...
    interface SDWebImageDownloader {
        ...
        ISDWebImageOperation DownloadImageWithURL(NSUrl url, SDWebImageDownloaderOptions options, Action<int, int> progressBlock, Action<UIImage, NSData, NSError, sbyte> completedBlock);
    ...
    interface SDWebImageManager {
        ...
        [Export("downloadImageWithURL:options:progress:completed:")]
        ISDWebImageOperation DownloadImageWithURL(NSUrl url, SDWebImageOptions options, Action<int, int> progressBlock, Action<UIImage, NSError, SDImageCacheType, sbyte, NSUrl> completedBlock);
