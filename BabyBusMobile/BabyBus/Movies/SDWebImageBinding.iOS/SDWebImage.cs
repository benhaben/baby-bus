namespace SDWebImage {
	...
	interface WebCache {
		...
		void Sd_setImageWithURL (NSUrl url, UIControlState state, UIImage placeholder, Action<UIImage, NSError, SDImageCacheType, NSUrl> completedBlock);

		// -(void)sd_setImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(SDWebImageCompletionBlock)completedBlock;
		[Export ("sd_setImageWithURL:forState:placeholderImage:options:completed:")]
		void Sd_setImageWithURL (NSUrl url, UIControlState state, UIImage placeholder, SDWebImageOptions options, Action<UIImage, NSError, SDImageCacheType, NSUrl> completedBlock);
		...
		void Sd_setBackgroundImageWithURL (NSUrl url, UIControlState state, UIImage placeholder, Action<UIImage, NSError, SDImageCacheType, NSUrl> completedBlock);

		// -(void)sd_setBackgroundImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(SDWebImageCompletionBlock)completedBlock;
		[Export ("sd_setBackgroundImageWithURL:forState:placeholderImage:options:completed:")]
		void Sd_setBackgroundImageWithURL (NSUrl url, UIControlState state, UIImage placeholder, SDWebImageOptions options, Action<UIImage, NSError, SDImageCacheType, NSUrl> completedBlock);
	...
	interface WebCacheDeprecated {
		...
		void SetImageWithURL (NSUrl url, UIControlState state, Action<UIImage, NSError, SDImageCacheType> completedBlock);
		...
		void SetImageWithURL (NSUrl url, UIControlState state, UIImage placeholder, Action<UIImage, NSError, SDImageCacheType> completedBlock);

		// -(void)setImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(SDWebImageCompletedBlock)completedBlock;
		[Availability (Deprecated = Platform.iOS | Platform.Mac)]
		[Export ("setImageWithURL:forState:placeholderImage:options:completed:")]
		void SetImageWithURL (NSUrl url, UIControlState state, UIImage placeholder, SDWebImageOptions options, Action<UIImage, NSError, SDImageCacheType> completedBlock);
		...
		void SetBackgroundImageWithURL (NSUrl url, UIControlState state, Action<UIImage, NSError, SDImageCacheType> completedBlock);
		...
		void SetBackgroundImageWithURL (NSUrl url, UIControlState state, UIImage placeholder, Action<UIImage, NSError, SDImageCacheType> completedBlock);

		// -(void)setBackgroundImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(SDWebImageCompletedBlock)completedBlock;
		[Availability (Deprecated = Platform.iOS | Platform.Mac)]
		[Export ("setBackgroundImageWithURL:forState:placeholderImage:options:completed:")]
		void SetBackgroundImageWithURL (NSUrl url, UIControlState state, UIImage placeholder, SDWebImageOptions options, Action<UIImage, NSError, SDImageCacheType> completedBlock);
	...
	// @interface HighlightedWebCacheDeprecated (UIImageView)
	[Category]
	[BaseType (typeof (UIImageView))]
	interface HighlightedWebCacheDeprecated {

		// -(void)setHighlightedImageWithURL:(NSURL *)url;
		[Availability (Deprecated = Platform.iOS | Platform.Mac)]
		[Export ("setHighlightedImageWithURL:")]
		void SetHighlightedImageWithURL (NSUrl url);

		// -(void)setHighlightedImageWithURL:(NSURL *)url options:(SDWebImageOptions)options;
		[Availability (Deprecated = Platform.iOS | Platform.Mac)]
		[Export ("setHighlightedImageWithURL:options:")]
		void SetHighlightedImageWithURL (NSUrl url, SDWebImageOptions options);

		// -(void)setHighlightedImageWithURL:(NSURL *)url completed:(SDWebImageCompletedBlock)completedBlock;
		[Availability (Deprecated = Platform.iOS | Platform.Mac)]
		[Export ("setHighlightedImageWithURL:completed:")]
		void SetHighlightedImageWithURL (NSUrl url, Action<UIImage, NSError, SDImageCacheType> completedBlock);
		...
		[Availability (Deprecated = Platform.iOS | Platform.Mac)]
		[Export ("setHighlightedImageWithURL:options:completed:")]
		void SetHighlightedImageWithURL (NSUrl url, SDWebImageOptions options, Action<UIImage, NSError, SDImageCacheType> completedBlock);
		...
		[Availability (Deprecated = Platform.iOS | Platform.Mac)]
		[Export ("setHighlightedImageWithURL:options:progress:completed:")]
		void SetHighlightedImageWithURL (NSUrl url, SDWebImageOptions options, Action<int, int> progressBlock, Action<UIImage, NSError, SDImageCacheType> completedBlock);

		// -(void)cancelCurrentHighlightedImageLoad;
		[Availability (Deprecated = Platform.iOS | Platform.Mac)]
		[Export ("cancelCurrentHighlightedImageLoad")]
		void CancelCurrentHighlightedImageLoad ();
	}
	...
	interface WebCache {
		...
		void Sd_setImageWithURL (NSUrl url, UIImage placeholder);

		// -(void)sd_setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options;
		[Export ("sd_setImageWithURL:placeholderImage:options:")]
		void Sd_setImageWithURL (NSUrl url, UIImage placeholder, SDWebImageOptions options);
		...
		void Sd_setImageWithURL (NSUrl url, UIImage placeholder, Action<UIImage, NSError, SDImageCacheType, NSUrl> completedBlock);

		// -(void)sd_setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(SDWebImageCompletionBlock)completedBlock;
		[Export ("sd_setImageWithURL:placeholderImage:options:completed:")]
		void Sd_setImageWithURL (NSUrl url, UIImage placeholder, SDWebImageOptions options, Action<UIImage, NSError, SDImageCacheType, NSUrl> completedBlock);

		// -(void)sd_setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletionBlock)completedBlock;
		[Export ("sd_setImageWithURL:placeholderImage:options:progress:completed:")]
		void Sd_setImageWithURL (NSUrl url, UIImage placeholder, SDWebImageOptions options, Action<int, int> progressBlock, Action<UIImage, NSError, SDImageCacheType, NSUrl> completedBlock);
		...
		void Sd_setImageWithPreviousCachedImageWithURL (NSUrl url, UIImage placeholder, SDWebImageOptions options, Action<int, int> progressBlock, Action<UIImage, NSError, SDImageCacheType, NSUrl> completedBlock);
	...
	// @interface WebCacheDeprecated (UIImageView)
	[Category]
	[BaseType (typeof (UIImageView))]
	interface WebCacheDeprecated {
		...
		void SetImageWithURL (NSUrl url, Action<UIImage, NSError, SDImageCacheType> completedBlock);

		// -(void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder completed:(SDWebImageCompletedBlock)completedBlock;
		[Availability (Deprecated = Platform.iOS | Platform.Mac)]
		[Export ("setImageWithURL:placeholderImage:completed:")]
		void SetImageWithURL (NSUrl url, UIImage placeholder, Action<UIImage, NSError, SDImageCacheType> completedBlock);

		// -(void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(SDWebImageCompletedBlock)completedBlock;
		[Availability (Deprecated = Platform.iOS | Platform.Mac)]
		[Export ("setImageWithURL:placeholderImage:options:completed:")]
		void SetImageWithURL (NSUrl url, UIImage placeholder, SDWebImageOptions options, Action<UIImage, NSError, SDImageCacheType> completedBlock);

		// -(void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletedBlock)completedBlock;
		[Availability (Deprecated = Platform.iOS | Platform.Mac)]
		[Export ("setImageWithURL:placeholderImage:options:progress:completed:")]
		void SetImageWithURL (NSUrl url, UIImage placeholder, SDWebImageOptions options, Action<int, int> progressBlock, Action<UIImage, NSError, SDImageCacheType> completedBlock);

		// -(void)setAnimationImagesWithURLs:(NSArray *)arrayOfURLs;
		[Availability (Deprecated = Platform.iOS | Platform.Mac)]
		[Export ("setAnimationImagesWithURLs:")]
		void SetAnimationImagesWithURLs (NSObject [] arrayOfURLs);
