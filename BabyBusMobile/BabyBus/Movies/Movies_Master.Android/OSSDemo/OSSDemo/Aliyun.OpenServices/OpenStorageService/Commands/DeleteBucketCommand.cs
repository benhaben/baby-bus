...
// Type: Aliyun.OpenServices.OpenStorageService.Commands.DeleteBucketCommand
...
namespace Aliyun.OpenServices.OpenStorageService.Commands
{
  ...
  internal class DeleteBucketCommand : OssCommand
  {
    ...
    private DeleteBucketCommand(IServiceClient client, Uri endpoint, ExecutionContext context, string bucketName)
