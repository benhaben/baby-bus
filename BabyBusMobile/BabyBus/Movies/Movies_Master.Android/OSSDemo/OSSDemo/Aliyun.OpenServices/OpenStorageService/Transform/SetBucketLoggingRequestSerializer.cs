...
// Type: Aliyun.OpenServices.OpenStorageService.Transform.SetBucketLoggingRequestSerializer
...
namespace Aliyun.OpenServices.OpenStorageService.Transform
{
  internal class SetBucketLoggingRequestSerializer : RequestSerializer<SetBucketLoggingRequest, SetBucketLoggingRequestModel>
  {
    ...
    {
      return this.ContentSerializer.Serialize(new SetBucketLoggingRequestModel()
      {
        LoggingEnabled = new SetBucketLoggingRequestModel.SetBucketLoggingEnabled()
        {
