...
// Type: Aliyun.OpenServices.OpenStorageService.Commands.GetBucketAclCommand
...
namespace Aliyun.OpenServices.OpenStorageService.Commands
{
  ...
  internal class GetBucketAclCommand : OssCommand<AccessControlList>
  {
    ...
    private GetBucketAclCommand(IServiceClient client, Uri endpoint, ExecutionContext context, string bucketName, IDeserializer<ServiceResponse, AccessControlList> deserializer)
