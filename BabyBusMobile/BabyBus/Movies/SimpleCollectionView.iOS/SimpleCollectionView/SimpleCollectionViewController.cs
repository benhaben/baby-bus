...
namespace SimpleCollectionView
{
    public class SimpleCollectionViewController : UICollectionViewController
    {
        ...
        ///<Docs><param name="collectionView">To be added.</param><summary>The number of sections in the UICollectionView.</summary><returns>To be added.</returns><remarks>To be added.</remarks></Docs>
        public override int NumberOfSections (UICollectionView collectionView)
        {
            return animals.Count / 3 + 1;
        }
    ...
    public class Header : UICollectionReusableView
    {
        ...
        {
            label = new UILabel () {
                Frame = new System.Drawing.RectangleF (0, 0, 300, 50),
