    ...
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Hello World! {0}", sss1);
            {
                ...
                var r = YinEncrypt("shenyin", salt);
                var rr = YinEncrypt("shenyin", salt);
                Console.WriteLine("Hello World! {0}", r == rr);
                var rrr = YinEncrypt("shenyin1", salt);

            }

        }

        static string YinEncrypt(string password, byte[] salt)
        {
            // WinRT-like API
            int keyLengthInBytes = 15;
