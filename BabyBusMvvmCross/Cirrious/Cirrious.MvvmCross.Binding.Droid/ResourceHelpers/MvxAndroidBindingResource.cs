...
namespace Cirrious.MvvmCross.Binding.Droid.ResourceHelpers
{
        ...
        , IMvxAndroidBindingResource
    {
        ...
        private MvxAndroidBindingResource()
        {
            ...
            try
            {
                ...
                PermissionStylableGroupId =
                    (int[])SafeGetFieldValue(styleable, "Permission", new int[0]);
                IsVisiableId =
                    (int)SafeGetFieldValue(styleable, "Permission_IsVisiable");
            }
        ...
        public int[] PermissionStylableGroupId { get; private set; }
        public int IsVisiableId { get; private set; }
    }
}