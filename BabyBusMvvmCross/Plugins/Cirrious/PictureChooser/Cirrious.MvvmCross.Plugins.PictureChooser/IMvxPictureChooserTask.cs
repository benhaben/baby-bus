...
namespace Cirrious.MvvmCross.Plugins.PictureChooser
{
    public interface IMvxPictureChooserTask
    {
        ...
        /// <summary>
        /// Choose Pickture with Crop
        /// </summary>
        void ChoosePictureWithCrop(int maxPixelDimension, int percentQuality, Action<Stream> pictureAvailable,
            Action assumeCancelled);

		/// <summary>
		/// Take Pickture with Crop
		/// </summary>
		void TakePictureWithCrop(int maxPixelDimension, int percentQuality, Action<Stream> pictureAvailable,
			Action assumeCancelled);
