...
namespace CrossUI.Touch.Dialog {
    ...
    public class DialogViewController : UITableViewController {
        ...
        private UIActivityIndicatorView activity = new UIActivityIndicatorView(UIActivityIndicatorViewStyle.Gray);
        ...
        private EventHandler refreshRequestedUpPull;
        ...
        public event EventHandler RefreshRequestedUpPull {
            add {
                if (tableView != null)
                    throw new ArgumentException("You should set the handler before the controller is shown");
                refreshRequestedUpPull += value;
            }
            remove { refreshRequestedUpPull -= value; }
        }
        ...
        protected virtual void TriggerRefreshUpPull() {
            if (refreshRequestedUpPull != null && !reloading) {
                Console.WriteLine("调用上拉刷新方法");
                ...
                refreshRequestedUpPull(this, EventArgs.Empty);
            }
        }

        protected virtual void TriggerRefresh(bool showStatus) {
            if (refreshRequested != null && !reloading) {
        ...
        public class Source : UITableViewSource {
            ...
            public override void DraggingEnded(UIScrollView scrollView, bool willDecelerate) {
                ...
                var height = scrollView.ContentSize.Height > Container.TableView.Frame.Size.Height ? Container.TableView.Frame.Size.Height : scrollView.ContentSize.Height;

                // 调用上拉刷新方法
                if ((height - scrollView.ContentSize.Height + scrollView.ContentOffset.Y) >= yboundary) {
//                    var ae = new ActivityElement ();
//                    ae.Animating = true;
//                    Root.Sections [Root.Sections.Count - 1].Add (ae);
                   
                    Container.TriggerRefreshUpPull();
                }
        ...
        protected virtual float HeightForRow(UITableView containedTableView, NSIndexPath indexPath) {
            ...
            if (sizable == null)
                return (float)containedTableView.RowHeight;
