...
namespace CrossUI.Touch.Dialog.Elements
{
    ...
    /// </summary>
    public class Element : IElement, IDisposable,IReadableElement
    {
        ...
        protected WeakReference _viewController;
...
//            cell.DetailTextLabel
        ...
        /// The caption.
        /// </param>
        public Element(string caption, UIViewController viewController = null)
        {
            if (viewController != null)
            {
                _viewController = new WeakReference(viewController);
            }
            this.Caption = caption;
        }


        public Element(string caption, Action tapped, UIViewController viewController = null)
        {
            if (viewController != null)
            {
                _viewController = new WeakReference(viewController);
        ...
        {
            var cell = new UITableViewCell(UITableViewCellStyle.Default, CellKey);
