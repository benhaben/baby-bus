        ...
        public Uri ImageUri
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    //this function will call PrepareCell in the derive class and use DefaultRequestImage to load image
                    UpdateImage();
                }
            }
        }
...
//            label.lineBreakMode = NSLineBreakByTruncatingTail;
            ...
            else
            {
                ...
                if (Image != null)
                {
                    if (imgView != null)
                    {
                        imgView.Image = Image.ImageByScalingToMaxSize(20);
                    }
                }
                else
                {
                    if (imgView != null)
                    {
                        ...
                        {
                            imgView.SetImage(_extraInfo.Uri, UIImage.FromBundle(DefaultImageName), 0,
