...
//			cell.BackgroundColor = UIColor.Clear;
        ...
        protected virtual DateTime DateTimeFromPickerDateTime(NSDate simpleDate)
        {
            ...
            return new DateTime((int)components.Year, (int)components.Month, (int)components.Day, (int)components.Hour
                , (int)components.Minute, (int)components.Second, DateTimeKind.Utc);
        }
        ...
        public override void Selected(DialogViewController dvc, UITableView tableView, NSIndexPath path)
        {
            ...
            _datePicker.Date = DateTimeToPickerDateTime(Value.HasValue ? Value.Value : DateTime.UtcNow).DateTimeToNSDate();
