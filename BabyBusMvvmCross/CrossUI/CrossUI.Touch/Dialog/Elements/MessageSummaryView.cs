...
#warning Virtual method call in constructor
        ...
        public override void Draw(CGRect rect) {
            ...
            UIKit.UIStringDrawing.DrawString(label, new CGRect(Bounds.Width - dateSize, 6, dateSize, 14), SubjectFont,
            ...
            UIKit.UIStringDrawing.DrawString(Sender, new PointF(offset, 2), bw - dateSize, SenderFont, UILineBreakMode.TailTruncation);
            UIKit.UIStringDrawing.DrawString(Subject, new PointF(offset, 23), bw - offset - boxWidth, SubjectFont,
                UILineBreakMode.TailTruncation);

            //UIColor.Black.SetFill ();
            //ctx.FillRect (new RectangleF (offset, 40, bw-boxWidth, 34));
            UIColor.Gray.SetColor();
            UIKit.UIStringDrawing.DrawString(Body, new CGRect(offset, 40, bw - boxWidth, 34), TextFont, UILineBreakMode.TailTruncation,
