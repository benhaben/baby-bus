...
namespace CrossUI.Touch.Dialog.Elements {
    ...
    public class BadgeElement : Element, IElementSizing {
        ...
        public BadgeElement(UIImage badgeImage, string cellText, Action tapped)
            : base(cellText) {
        ...
        public float GetHeight(UITableView tableView, NSIndexPath indexPath) {
            ...
            var height = UIKit.UIStringDrawing.StringSize(Caption, Font, size, LineBreakMode).Height + 10;

            // Image is 57 pixels tall, add some padding
            return (float)Math.Max(height, 63);
        }
