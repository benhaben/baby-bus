...
namespace CrossUI.Touch.Dialog.Utilities {
    ...
    public class RefreshTableHeaderView : UIView {
        private static readonly UIImage arrow = UIImage.FromBundle("Dialog/Images/" + "arrow" + ".png");
        //            Util.FromResource (null, "arrow.png");
        protected UIActivityIndicatorView Activity;
        protected UILabel LastUpdateLabel, StatusLabel;
        protected UIImageView ArrowView;

        public RefreshTableHeaderView(CGRect rect)
            : base(rect) {
        ...
        public DateTime LastUpdate {
            ...
            set {
                ...
                if (value == DateTime.MinValue) {
                    LastUpdateLabel.Text = "上次更新: 没有".GetText();
                } else
                    LastUpdateLabel.Text = String.Format("上次更新: {0:g}".GetText(), value);
            }
        }
